...
# Входная папка, содержащая SHP-файлы, выходная папка для файлов JSON и CSV
...
# Выполнение итерации по каждому SHP-файлу и выполнение преобразования
for shp_file in shp_files:
    processed_files += 1
    print(f"Конвиртируется в файл {processed_files}/{total_files}: {shp_file}")

    # Создание пути к файлам для входных и выходных файлов
